...
export class $npmConfigName1773291614741 implements MigrationInterface {
  name = ' $npmConfigName1773291614741';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "product_collections" ("product_id" uuid NOT NULL, "collection_id" integer NOT NULL, CONSTRAINT "PK_662f5fbef7b3b65daf2c4ce25c0" PRIMARY KEY ("product_id", "collection_id"))`,
    );
    await queryRunner.query(`CREATE INDEX "IDX_c876fae7420b26100e0767e7ad" ON "product_collections" ("product_id") `);
    await queryRunner.query(
      `CREATE INDEX "IDX_2f6ff219d1b76f164f46f514fc" ON "product_collections" ("collection_id") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "product_collections" ADD CONSTRAINT "FK_c876fae7420b26100e0767e7ad1" FOREIGN KEY ("product_id") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE CASCADE`,
    );
    await queryRunner.query(
      `ALTER TABLE "product_collections" ADD CONSTRAINT "FK_2f6ff219d1b76f164f46f514fcd" FOREIGN KEY ("collection_id") REFERENCES "collections"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
