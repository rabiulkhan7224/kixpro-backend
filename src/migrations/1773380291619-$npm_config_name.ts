...
export class  $npmConfigName1773380291619 implements MigrationInterface {
    name = ' $npmConfigName1773380291619'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "categories" ADD "parentCategoryId" uuid`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "collections" ADD "type" "public"."collections_type_enum" NOT NULL DEFAULT 'manual'`);
